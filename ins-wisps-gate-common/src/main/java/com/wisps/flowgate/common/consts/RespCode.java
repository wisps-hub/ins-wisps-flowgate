...
public enum RespCode {
    ...
    DUBBO_METHOD_NOT_FOUND(HttpResponseStatus.NOT_FOUND, 10021, "方法不存在"),
    ...
    WHITELIST(HttpResponseStatus.FORBIDDEN, 10005, "请求IP在白名单"),
    ...
    RespCode(HttpResponseStatus status, int code, String msg) {
        this.status = status;
        this.code = code;
        this.msg = msg;
    }
